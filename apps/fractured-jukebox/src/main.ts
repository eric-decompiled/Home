      ...
      <div class="canvas-wrap">
        ...
        <div class="play-overlay visible" id="play-overlay">
          <div class="play-overlay-header">
            ...
            <div class="play-overlay-subtitle">MIDI Visualizer</div>
          </div>
  ...
  <div class="about-modal-overlay" id="about-modal-overlay">
    <div class="about-modal">
      ...
      <div class="about-modal-body">
        ...
        <p class="about-contact">Found a bug? Have a feature idea or song request? <a href="mailto:eric@decompiled.dev">eric@decompiled.dev</a></p>
